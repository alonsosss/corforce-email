...
func TestBuzonBorradoRetiraLosTrabajosDeEsaEmpresaYEseBuzon(t *testing.T) {
...
func TestUnFalloTransitorioNoConfirmaYUnaEmpresaDesconocidaSi(t *testing.T) {
	transient := &fakePurger{err: errors.New("base caida")}
	...
	unknown := &fakePurger{err: fmt.Errorf("abrir la base: %w", domain.ErrTenantUnknown)}
