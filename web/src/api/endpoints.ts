...
export const endpoints = {
  ...
  webmail: {
    ...
    batch: (folder: string) => `${API_PREFIX}/webmail/folders/${seg(folder)}/messages/batch`,
    raw: (folder: string, uid: number) =>
      `${API_PREFIX}/webmail/folders/${seg(folder)}/messages/${uid}/raw`,
    ...
    scheduled: `${API_PREFIX}/webmail/scheduled`,
    scheduledItem: (id: string) => `${API_PREFIX}/webmail/scheduled/${seg(id)}`,
