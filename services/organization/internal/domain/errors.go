...
var (
	...
	ErrInvalidTenantStatus = errors.New("estado de tenant no válido")
	...
	ErrTenantStillActive = errors.New("el tenant sigue activo: suspéndelo o dalo de baja antes de borrarlo")
	...
	ErrCellCodeExists  = errors.New("ya existe una celda con ese código")
	ErrInvalidCellCode = errors.New("código de celda no válido")
	...
	ErrInvalidCellStatus  = errors.New("estado de celda no válido")
	ErrNothingToUpdate    = errors.New("la petición no trae ningún campo que actualizar")
	ErrAdminUserRequired  = errors.New("el alta exige el correo y la contraseña del primer administrador")
	ErrAdminPasswordShort = errors.New("la contraseña del primer administrador es demasiado corta")
	...
	ErrLeaseLost = errors.New("la saga de la empresa pasó a otra instancia")
	...
	ErrProvisioningMismatch = errors.New("el alta pendiente de esa empresa se pidió en otra celda")
	...
	ErrAdminRejected = errors.New("identity rechazó al primer administrador")
	...
	ErrInvalidMailDomain = errors.New("nombre de dominio de correo no válido")
	// ErrMailDomainNotFound: el dominio no esta activo en ninguna celda (no esta en el indice).
	ErrMailDomainNotFound = errors.New("el dominio de correo no está activo en ninguna celda")
	...
	ErrMailDomainClaimed = errors.New("el dominio de correo ya está activo en otra empresa")
	// ErrTenantBeingRemoved: la empresa tiene la baja en curso; no reclama dominios de correo.
	ErrTenantBeingRemoved = errors.New("la empresa se está dando de baja: no reclama dominios de correo")
)
