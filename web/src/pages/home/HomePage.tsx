...
const CARDS: HomeCard[] = [
  ...
  {
    to: paths.reputation,
    titleKey: 'home.card.reputation',
    descriptionKey: 'home.card.reputationDesc',
    icon: IconActivity,
    module: MODULES.reputation,
  },
  {
    to: paths.contacts,
    titleKey: 'home.card.contacts',
    descriptionKey: 'home.card.contactsDesc',
    icon: IconAddressBook,
    module: MODULES.contacts,
  },
  {
    to: paths.segments,
    titleKey: 'home.card.segments',
    descriptionKey: 'home.card.segmentsDesc',
    icon: IconTarget,
    module: MODULES.segments,
  },
  {
    to: paths.campaigns,
    titleKey: 'home.card.campaigns',
    descriptionKey: 'home.card.campaignsDesc',
    icon: IconSend,
    module: MODULES.campaigns,
  },
  {
    to: paths.analytics,
    titleKey: 'home.card.analytics',
    descriptionKey: 'home.card.analyticsDesc',
    icon: IconBarChart,
    module: MODULES.analytics,
  },
  {
    to: paths.billing,
    titleKey: 'home.card.billing',
    descriptionKey: 'home.card.billingDesc',
    icon: IconGauge,
  ...
  },
  {
    ...
    titleKey: 'home.card.platformBilling',
    descriptionKey: 'home.card.platformBillingDesc',
    icon: IconCreditCard,
    role: SYSTEM_ROLES.superadmin,
  },
  {
    to: paths.platformReputation,
    titleKey: 'home.card.platformReputation',
    descriptionKey: 'home.card.platformReputationDesc',
    icon: IconActivity,
    role: SYSTEM_ROLES.superadmin,
  },
  {
