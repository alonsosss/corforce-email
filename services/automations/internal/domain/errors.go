...
var (
	...
	ErrConcurrentChange  = errors.New("el flujo cambio mientras se procesaba la peticion; vuelva a intentarlo")

	// ErrInvalidInput agrupa los datos de entrada que no cumplen el contrato; el detalle
	// viaja en ValidationError.
	ErrInvalidInput = errors.New("datos no validos")

	ErrTemplateNotFound   = errors.New("la plantilla no existe")
	ErrNoPublishedVersion = errors.New("la plantilla no tiene una version publicada o esta archivada")
