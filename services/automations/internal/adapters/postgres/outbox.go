...
const eventSource = "automations"

// OutboxPublisher implementa ports.EventPublisher sobre platform.event_outbox de la base
// de la empresa: el evento se escribe en la misma transaccion que el cambio y el rele
// (outbox.RunForTenants) lo publica en el stream AUTOMATIONS.
...
// Publish deja en UserID a quien actuo cuando la transicion la pidio una persona; las del
// ejecutor van sin usuario.
