...
# make check-secret-scope  (cada contenedor recibe solo los secretos de su fila en
# ops/security/secrets/reparto.tsv: compose, codigo y lista de secretos dicen lo mismo, y el
