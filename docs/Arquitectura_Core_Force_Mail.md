...
### 2.3 Transaccional y marketing (empresa). Estado: `transactional`, `templates` y `suppression` verificados (2026-09-12); `reputation` verificado contra Postgres y Redis reales (2026-09-13); carril de marketing y autorizacion previa de `transactional` verificados con pruebas unitarias e integracion contra Postgres (2026-09-13), sin prueba de punta a punta con SES; `analytics` verificado con pruebas unitarias e integracion contra Postgres (2026-09-13); fase 4 en construccion (`contacts`, `billing`; despues `campaigns`, `automations`)
