...
var (
	...
	ErrNameTaken         = errors.New("ya existe una campaña con ese nombre")
	ErrInvalidTransition = errors.New("transición de estado no permitida")
	ErrNotEditable       = errors.New("la campaña solo se puede editar en borrador o en pausa")
	ErrLockedWhilePaused = errors.New("en pausa no se cambian la audiencia ni la plantilla")
	ErrNotDeletable      = errors.New("solo se eliminan campañas en borrador o canceladas")
	ErrNothingToUpdate   = errors.New("no hay cambios que aplicar")
	ErrScheduleInPast    = errors.New("la fecha de programación debe quedar en el futuro")
	ErrScheduleTooFar    = errors.New("la fecha de programación supera el horizonte permitido")
	ErrConcurrentChange  = errors.New("la campaña cambió mientras se procesaba la petición; vuelva a intentarlo")
	...
	ErrABWithTimezone   = errors.New("la prueba A/B no se combina con el envío por zona horaria")
	...
	ErrInvalidCampaign = errors.New("datos de campaña no válidos")

	ErrTemplateNotFound   = errors.New("la plantilla no existe")
	ErrNoPublishedVersion = errors.New("la plantilla no tiene una versión publicada")
