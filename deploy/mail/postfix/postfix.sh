...
# anterior y nunca se entregaba en local. `active IN (1, 2)` como el resto de los mapas: el 2 es
# "solo recibe" (no inicia sesion), que es justo el estado de un buzon al que se le corta el acceso
# durante una migracion; con `= 1` su correo se reenviaba al proveedor anterior.
